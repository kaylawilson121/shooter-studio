  ...
  return (
    <section className="flex flex-col w-full items-center gap-[50px] px-4 py-[50px] relative">
      <div className="flex flex-col items-center gap-[50px] relative w-full max-w-[1520px]">
        <div className="inline-flex flex-col items-center justify-center p-2.5 relative opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:0ms]">
          ...
          <p className="relative max-w-[1002px] [font-family:'Poppins',Helvetica] font-normal text-[#616267] text-3xl text-center tracking-[0] leading-[normal]">
            Dropbox Automation Automates Tasks, Syncing And Organizing Files To
            Save Time And Boost Productivity!
          </p>
        </div>

        <div className="flex items-center justify-center gap-2.5 px-0 py-2.5 relative w-full opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]">
          <Button className="w-[230px] h-14 px-4 py-2 bg-[#4183f1] hover:bg-[#3672d9] rounded-[100px] border-0 transition-colors">
        ...
        <div className="relative w-full max-w-[1240px] h-[824px] bg-[#1c1e20] rounded-[40px] shadow-[10px_0px_1px_#0000000a,0px_2px_6px_#0000001a,0px_16px_24px_#0000001a] opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:400ms]">
          <div className="absolute w-full h-[89.93%] top-[10.07%] left-0 flex rounded-[0px_0px_40px_40px] overflow-hidden">
            <img
              ...
              src="https://c.animaapp.com/mhejq8cn4pmF0V/img/magicpattern-design-3.png"
            />
          </div>
