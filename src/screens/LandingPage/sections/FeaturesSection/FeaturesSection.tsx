    ...
    <section className="flex flex-col w-full items-center gap-[50px] px-4 py-[50px] relative">
      <div className="flex flex-col items-center gap-[50px] relative w-full max-w-[1520px]">
        <header className="inline-flex flex-col items-center justify-center p-2.5 relative opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:0ms]">
          ...
          <p className="relative max-w-[1070px] [font-family:'Poppins',Helvetica] font-normal text-[#616267] text-3xl text-center tracking-[0] leading-[normal]">
            Team Management Is About Uniting A Group To Achieve Goals. It
            Involves Assigning Tasks And Maintaining Communication.
          </p>
        </header>

        <Card className="relative w-full max-w-[1240px] h-[824px] bg-[#1c1e20] rounded-[40px] shadow-[10px_0px_1px_#0000000a,0px_2px_6px_#0000001a,0px_16px_24px_#0000001a] border-0 opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]">
          <CardContent className="p-0 h-full relative">
            <div className="absolute w-full h-[89.93%] top-[10.07%] left-0 flex rounded-[0px_0px_40px_40px] overflow-hidden">
              <img
                ...
                src="https://c.animaapp.com/mhejq8cn4pmF0V/img/magicpattern-design-2.png"
              />
            </div>
        ...
        <div className="flex items-center justify-center gap-2.5 px-0 py-2.5 relative w-full opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:400ms]">
